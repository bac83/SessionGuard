...
mkdir -p "$STAGING_ROOT/etc/systemd/system"
...
cp "$ROOT_DIR/packaging/deb/sessionguard-agent.service" "$STAGING_ROOT/etc/systemd/system/sessionguard-agent.service"
...
chmod 0644 "$STAGING_ROOT/etc/systemd/system/sessionguard-agent.service"
